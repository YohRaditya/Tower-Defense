...

{
...

    {
        ...
        // _healthFill.size = _healthBar.size * (_currentHealth / _maxHealth);
        Vector2 newfill = _healthFill.size;
        Vector2 newbar = _healthBar.size;
        newfill.x = newbar.x * (_currentHealth / _maxHealth);
        _healthFill.size = newfill;
